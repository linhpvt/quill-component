...
// rebuild delta
export function matchTableCell(node: any, delta: any, scroll: any) {
...
export function matchTableHeader(node: any, delta: any, scroll: any) {
  const row = node.parentNode;
  const table =
    row.parentNode.tagName === 'TABLE'
      ? row.parentNode
...
export function matchTable(node: any, delta: any, scroll: any) {
  ...
  const maxCellsNumber = cellsInTopRow.reduce((sum: any, cell: any) => {
